...
const initialState = {
  ...
  addStepperViewPortBgColor:
    localStorage.getItem("ViewPortBgColor") || "#000000",
...
export const {
  setAddStepperFontSize,
  setAddStepperFontColorValue,
  setAddStepperViewPortFontWeight,
  setAddStepperViewPortBgColor,
  setFontFamily,
  setAddStepperViewPortHeight,
  setAddStepperKirtan,
  setAddStepperShortCutsObject,
  setAddStepperKirtanSlice,
  setAddStepperShortCutsNewObject,
} = addStepperSlice.actions;
