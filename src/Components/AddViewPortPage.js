...
const AddViewPortPage = ({ toShowOnDisplay, showInPlate }) => {
  ...
  useEffect(() => {
    if (location.pathname === "/edit") {
      dispatch(
        setAddStepperShortCutsNewObject(
          JSON.parse(localStorage.getItem("shortCutsObject"))
        ) || {}
      );
    }
  }, []);
  ...
  return (
    <div
      className="place-self-center overflow-y-scroll border-collapse h-[600px] stepper-page"
                  ...
                  <Grid item xs={4}>
                    ...
                    !(selectedButton === index) ? (
                      <Button
                        ...
                        variant="contained"
                        onClick={() => {
                          handleEditShortcutShowButton(index);
                        }}
                      >
                      ...
                      <div className="flex justify-center">
                        ...
                        <i
                          ...
                          className="fa-solid fa-check mx-2 text-[#3675e2]"
                        ></i>
                      </div>
                    ) : (
                      <IconButton
