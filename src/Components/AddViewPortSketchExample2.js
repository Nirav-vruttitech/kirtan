...
import { setAddStepperViewPortBgColor } from './../Slice/addStepperSlice';

const AddViewPortSketchExample2 = () => {
    const dispatch = useDispatch();
    const color = useSelector(state => state.addStepperSlice.addStepperViewPortBgColor);
    ...
    useEffect(() => {
        if (fontColorState.color) {
            dispatch(setAddStepperViewPortBgColor(fontColorState.color));
        }
    }, [fontColorState]);
...
export default AddViewPortSketchExample2;